    ...
    <div className="w-full">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div
          {...getRootProps({
            className:
              "flex flex-col items-center justify-center border-2 border-dashed border-base-300 p-6 rounded-xl cursor-pointer bg-base-100 aspect-video hover:border-primary transition-all",
          })}
        >
          <input {...getInputProps()} />
          <div className="flex flex-col items-center text-center">
            <LuCloudUpload size={40} className="text-base-content/40 mb-2" />
            {loading ? (
              ...
              <>
                ...
                <span className="opacity-60 text-xs mt-1">
          ...
          <div>
            {displayImages.map((img, i) => {
              ...
              return (
                <div
                  key={i}
                  className="relative group aspect-video rounded-xl overflow-hidden border border-base-200 bg-base-200"
                >
                  <img
                    src={img.url}
